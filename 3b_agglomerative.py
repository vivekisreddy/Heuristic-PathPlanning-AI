...
def evaluate_clustering(labels, labels_true, data):
    """
    Evaluate clustering performance and visualize the results.
...
def main():
    """
    Main function to execute agglomerative clustering on the provided dataset and evaluate the results.
    """
    ...
    # Evaluate clustering performance and plot the results
    evaluate_clustering(labels, labels_true, data)
